...
const index = require('./index-f69878a8.js');

/*
 Stencil Client Patch Browser v2.22.1 | MIT Licensed | https://stenciljs.com
 */
const patchBrowser = () => {
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('derockdev-discord-components-core.cjs.js', document.baseURI).href));
    const opts = {};
    if (importMeta !== '') {
